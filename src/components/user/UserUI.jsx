...
const UserUI = ({ onLogout, user: initialUser }) => {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      case "found":
        return <FoundPage posts={posts} setActiveTab={setActiveTab} setChatTarget={setChatTarget} searchQuery={searchQuery} />;
      case "lost":
        return <LostPage posts={posts} setActiveTab={setActiveTab} setChatTarget={setChatTarget} searchQuery={searchQuery} />;
      case "chat":
        return <ChatPage user={user} chatTarget={chatTarget} setActiveTab={setActiveTab} />;
      case "posts":
        return <UserProfile user={user} posts={posts} setPosts={setPosts} onLogout={onLogout} defaultTab="posts" onProfileUpdate={handleProfileUpdate} />;        
      case "profile":
        return <UserProfile user={user} posts={posts} setPosts={setPosts} onLogout={onLogout} onProfileUpdate={handleProfileUpdate} />;        
      default:
